...
export const BRAND_NAME = 'DatHuis';
export const SITE_NAME_MULTILINE = ['DatHuis', 'Conf'];
export const SITE_NAME = 'DatHuis Conf';
export const META_DESCRIPTION = 'An amazing conf organized by DatHuis';
